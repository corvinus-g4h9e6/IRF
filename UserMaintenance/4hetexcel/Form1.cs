...
namespace _4hetexcel
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void CreateTable()
        {
            ...
            Excel.Range firstCol = xlSheet.get_Range(GetCell(1, 1), GetCell(lastRowID, 1));
            firstCol.Font.Bold = true;
            firstCol.Interior.Color = Color.LightYellow;
            Excel.Range lastCol = xlSheet.get_Range(GetCell(1, headers.Length), GetCell(lastRowID, headers.Length));
